<div class="um-activity-comments">
	...
	<?php if ( is_user_logged_in() && UM()->Activity_API()->api()->can_comment() ) { ?>

	<div class="um-activity-commentl um-activity-comment-area">
		<div class="um-activity-comment-avatar"><?php echo get_avatar( get_current_user_id(), 80 ); ?></div>
	...
	<div class="um-activity-comments-loop">
		...
		<div class="um-activity-commentl um-activity-commentl-clone">
			<a href="#" class="um-activity-comment-hide um-tip-s" title="<?php _e('Hide','um-activity'); ?>">
			...
			<div class="um-activity-comment-info">
				<div class="um-activity-comment-data">
					...
					<textarea id="um-activity-reply-0" class="original-content" style="display:none!important"><?php
				...
				<div class="um-activity-comment-meta">
					...
					<?php if ( UM()->Activity_API()->api()->can_comment() ) { ?><span><a href="#" class="um-link um-activity-comment-reply" data-commentid="0"><?php _e('Reply','um-activity'); ?></a></span><?php } ?>
		...
		<div class="um-activity-commentwrap-clone" data-comment_id="">
			<div class="um-activity-comment-child"></div>
		</div>
		...
		<div class="um-activity-commentl is-child um-activity-commentlre-clone">
			...
			<div class="um-activity-comment-avatar"><a href="<?php echo um_user_profile_url(); ?>"><?php echo get_avatar( get_current_user_id(), 80 ); ?></a></div>
			<div class="um-activity-comment-info">
				<div class="um-activity-comment-data">
					<span class="um-activity-comment-author-link"><a href="<?php echo um_user_profile_url(); ?>" class="um-link"><?php echo um_user('display_name'); ?></a></span> <span class="um-activity-comment-text"></span>
					<textarea id="um-activity-reply-0" class="original-content" style="display:none!important"><?php
