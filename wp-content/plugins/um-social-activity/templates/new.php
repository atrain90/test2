<div class="um-activity-widget um-activity-new-post">
	...
	<div class="um-activity-foot">
		...
		<div class="um-activity-left um-activity-insert">
			...
			<a href="#" class="um-activity-insert-photo um-tip-s" data-timestamp="<?php echo $timestamp;?>" data-nonce="<?php echo $nonce;?>" title="<?php _e('Add photo','um-activity'); ?>" data-allowed="gif,png,jpeg,jpg" data-size-err="<?php _e('Image is too large','um-activity'); ?>" data-ext-err="<?php _e('Please upload a valid image','um-activity'); ?>"><i class="um-faicon-camera"></i></a>
			<?php } ?>
	...
	<input type="hidden" name="action" id="action" value="activity_publish" />
