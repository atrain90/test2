			<div class="um-activity-commentl is-child" id="commentid-<?php echo $commentc->comment_ID; ?>">
				...
				<div class="um-activity-comment-info hidden-<?php echo $user_hidden; ?>">
					<div class="um-activity-comment-data">
						...
						<textarea id="um-activity-reply-<?php echo $commentc->comment_ID; ?>" class="original-content" style="display:none!important"><?php if( isset( $comment->comment_content ) ){ echo $comment->comment_content; } ?></textarea>
					</div>
					<div class="um-activity-comment-meta">
						<?php if ( is_user_logged_in() ) { ?>

						<?php if ( UM()->Activity_API()->api()->can_comment() ) { ?><span><a href="#" class="um-link um-activity-comment-reply" data-commentid="<?php echo $comment->comment_ID; ?>"><?php _e('Reply','um-activity'); ?></a></span><?php } ?>
